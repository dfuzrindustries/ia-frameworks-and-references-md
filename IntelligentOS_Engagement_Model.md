<!-- PAGE_TITLE: IntelligentOS Engagement Model -->
<!-- BREADCRUMB: Intelligent Agency Frameworks > IntelligentOS Engagement Model -->
...
This framework defines how we look at organizations through three complementary lenses, each providing different altitude and detail, all aligned to a common 8-layer architectural stack.
...
1. **Business Model** - Strategic foundation and organizational readiness
2. **Operating Model** - Value streams, workflows, and operational execution
3. **Agentic Platform Model** - Technology infrastructure enabling AI transformation
...
Initial client conversations, executive presentations, strategic alignment sessions

### Key Deliverables

- VMP Statement
- OKR Cascade (Company → Function → Team)
- Brand Positioning Map
- Culture Assessment (Current vs. Desired)
- Business Model Canvas

**Format**: Presentations, Workshop outputs

---

## VIEW 2: OPERATING MODEL
...
Workshop documentation, platform requirements gathering, detailed process mapping
...
**Format**: Operational Schema docs, Process diagrams

---

## VIEW 3: AGENTIC PLATFORM MODEL
...
Platform design, technical architecture, AI implementation planning, infrastructure requirements
...
- **Phase 0** → All Layers (Current State Assessment)
...
Planning discovery work, structuring workshops, designing transformation roadmaps
...
**Format**: Reports, Presentations, Roadmaps
...
## The 8-Layer Architectural Stack
...
|-----------|------------------|--------|
| **Business Model → Operating Model** | Strategic priorities define which value streams to optimize | OKRs cascade into workflow-level metrics; Culture assessment informs change approach |
| **Operating Model → Agentic Platform Model** | Workflow specifications define agent requirements | Decision architecture determines orchestration; Data flows identify semantic layer needs |
| **Agentic Platform Model → Operating Model** | Agent capabilities enable new workflow designs | Technical constraints shape operational feasibility; Platform maturity determines scope |
| **Discovery Methodology → All Views** | Phases 1-2 populate Business Model; Phases 2-4 populate Operating Model; Phase 6 populates Agentic Platform Model | Phases 0, 5, 7 span all views with assessment, org design, and change enablement |

---

## Deliverables by View

| View | Key Artifacts | Format |
|------|---------------|--------|
| **Business Model** | • VMP Statement<br>• OKR Cascade (Company → Function → Team)<br>• Brand Positioning Map<br>• Culture Assessment (Current vs. Desired)<br>• Business Model Canvas | Presentations, Workshop outputs |
| **Operating Model** | • Value Stream Maps<br>• Workflow Specifications<br>• RACI Matrices<br>• Process Documentation<br>• SLA & Governance Framework | Operational Schema docs, Process diagrams |
| **Agentic Platform Model** | • Technical Architecture Diagram<br>• Agent Specifications<br>• Data Model & Schema<br>• Infrastructure Requirements<br>• Integration Architecture | Technical specs, Architecture docs |
...
## Practical Example: Permit Approval Process
...
|-----------|-------------|-------------|--------------|
| **Business Model** | Client presentations | Leadership | Frames strategic foundation and readiness |
| **Operating Model** | Workshop documentation | Delivery teams | Defines operational structure |
| **Agentic Platform Model** | Technical architecture | Platform/AI teams | Specifies technology foundation |
...
- **Track 1 (Strategy)** uses Business Model view to align on vision, feeds Discovery Methodology Phases 1-2
- **Track 2 (Transformation)** uses Discovery Methodology, documents in Operating Model structure
- **Track 3 (Platform & AI)** uses Agentic Platform Model specifications to build the target platform
...
4. Track 3 builds the platform based on Agentic Platform Model specs
5. All tracks measure success using Business Model metrics and OKRs

---

## Integration with Framework Documents

This engagement model connects to our framework documentation:

**← Business Canvas**: Implements Business Model view - Strategic Foundation Mapping

**← Operational Canvas**: Implements Operating Model view - Value Stream and Workflow mapping
...
**→ KPI Architecture**: Implements Phase 1 (Success Model & KPIs) across all views
...
*The IntelligentOS Engagement Model provides three complementary views of organizational transformation, all aligned to a common 8-layer architectural stack, enabling strategic clarity, operational precision, and technical excellence.*
